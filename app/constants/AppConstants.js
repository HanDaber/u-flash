...
// URLs assumed to include an ending /
...
export const S3_BUCKET_URL = 'http://s3-us-west-2.amazonaws.com/static-bucket/'
export const S3_PUBLIC_URL = 'http://website-bucket(.com).s3-website-us-west-2.amazonaws.com/'
